...
<div class="bg-white rounded-lg shadow overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-200">
        <h2 class="text-2xl font-bold text-gray-800">Додати нову картку</h2>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="level" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        ...
                        <option value="Початковий" {{ old('level') == 'Початковий' ? 'selected' : '' }}>Початковий</option>
                        <option value="Середній" {{ old('level') == 'Середній' ? 'selected' : '' }}>Середній</option>
                        <option value="Просунутий" {{ old('level') == 'Просунутий' ? 'selected' : '' }}>Просунутий</option>
                    </select>
